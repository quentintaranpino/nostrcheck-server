...
const initDatabase = async (): Promise<void> => {
	...
	if (publicLightning == ""){
		...
		const values: string[] = [app.get("config.server")["pubkey"], "serverLightningAddress", "Public lightning redirect generated by server on first run, edit this to recieve SATS on your wallet"];
