...
const PrepareNIP94_event = async (filedata : FileData): Promise<NIP94_event> => {
        ...
        const event : NIP94_event = {
                ...
                tags: [
                        ...
                        ["size", filedata.processing_url == "" ? filedata.filesize? filedata.filesize.toString() : "0" : "0"],
                        ["dim",filedata.processing_url == "" ? filedata.width != 0 && filedata.height != 0? filedata.width + "x" + filedata.height : "0x0" : "0x0"],
