...
- New home page with quickstart, connect endpoints, stats and recent activity.
...
- Documentation page rewritten with endpoint specs, supported NIPs / BUDs and wiki chapter links.
